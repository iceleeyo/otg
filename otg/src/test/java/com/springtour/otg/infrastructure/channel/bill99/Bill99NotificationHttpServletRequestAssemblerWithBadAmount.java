 ...
 * @author Future
 */
public class Bill99NotificationHttpServletRequestAssemblerWithBadAmount extends Bill99NotificationHttpServletRequestAssemblerImpl {
    ...
    private String mockPurchaseTr3Message(Transaction transaction) {
        ...
        txEle.addElement("amount").setText("-12.3");
