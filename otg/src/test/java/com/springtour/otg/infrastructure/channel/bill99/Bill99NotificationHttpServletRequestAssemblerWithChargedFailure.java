 ...
 * @author Future
 */
public class Bill99NotificationHttpServletRequestAssemblerWithChargedFailure extends Bill99NotificationHttpServletRequestAssemblerImpl {
    ...
    private String mockPurchaseTr3Message(Transaction transaction) {
        ...
        txEle.addElement("responseCode").setText("55");//tr3时至判断responseCode
