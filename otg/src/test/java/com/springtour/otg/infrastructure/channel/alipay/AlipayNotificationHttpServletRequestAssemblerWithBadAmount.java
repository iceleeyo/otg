 ...
 * @author Future
 */
public class AlipayNotificationHttpServletRequestAssemblerWithBadAmount extends AlipayNotificationHttpServletRequestAssemblerImpl {

    @Override
    public MockHttpServletRequest assemble(Transaction transaction) {
        MockHttpServletRequest request = super.assemble(transaction);
        request.setParameter("total_fee", "123123");
        return request;
    }
}
