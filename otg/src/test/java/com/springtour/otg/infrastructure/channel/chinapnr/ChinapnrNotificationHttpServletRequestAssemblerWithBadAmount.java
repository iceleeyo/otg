 ...
 * @author 001595
 */
public class ChinapnrNotificationHttpServletRequestAssemblerWithBadAmount extends ChinapnrNotificationHttpServletRequestAssemblerImpl {

    @Override
    public MockHttpServletRequest assemble(Transaction transaction) {
        MockHttpServletRequest request = super.assemble(transaction);
        request.setParameter("OrdAmt", "12");
        return request;
    }
}
