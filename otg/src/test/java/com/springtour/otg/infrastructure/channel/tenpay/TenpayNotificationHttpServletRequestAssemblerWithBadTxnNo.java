 ...
 * @author 006874
 */
public class TenpayNotificationHttpServletRequestAssemblerWithBadTxnNo extends TenpayNotificationHttpServletRequestAssemblerImpl {

    @Override
    public MockHttpServletRequest assemble(Transaction transaction) {
        MockHttpServletRequest request = super.assemble(transaction);

        request.setParameter("out_trade_no", "32424");
        return request;
    }
}
