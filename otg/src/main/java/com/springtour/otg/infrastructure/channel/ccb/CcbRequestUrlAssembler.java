...
public class CcbRequestUrlAssembler extends AbstractCcbUrlAssembler {

	@Setter
	private Configurations configurations;

	public StringBuilder requstUrlPrefix() {
		StringBuilder url = new StringBuilder(configurations.getCcbRequestUrl());
		url.append("?");
		return url;
	}
	...
	public Map<String, String> makeParameters(Transaction transaction,
		...
		param.put("TXCODE", CcbConstants.TXCODE);
		param.put("REMARK1", "");
		param.put("REMARK2", "");
		...
		param.put("PUB", pub);
		param.put("GATEWAY", CcbConstants.GATEWAY);
